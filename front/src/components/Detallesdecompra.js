            ...
            <div class="col-lg-9 mx-auto">
              ...
              <ul class="list-group shadow">
                ...
                <li class="list-group-item">
                  <h3 class="mt-0 mb-1">Detalles del producto</h3>
                      ...
                      <div class="d-flex align-items-center justify-content-between mt-1">
                        ...
                        <ul class="list-inline small">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <textarea name="texto" cols="30" rows="5">
                          ...
                          <div class="form-group row">
                            <label for="inputtext" class="col-sm-2 col-form-label">Unidades:</label>
                            <div class="col-sm-10">
                              <input type="text" class="form-control" id="inputPassword3" />
                            </div>
                          </div>
                          <div class="mt-3"><button class="btn btn-dark mr-2" type="button">ATRAS</button><button
                            class="btn btn-danger" type="button">COMPRAR AHORA</button></div>
                        </ul>
